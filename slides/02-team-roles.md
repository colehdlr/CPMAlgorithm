...
**Speaker:** Samuel | **Time:** 50 seconds
...
|------|------|-----|-------------|
| Samuel | Dev + Scrum Master | Knowledge of team member strengths | Co-ordinator |
| Jamie | Dev + Product Owner | Additional research into CPM | Specialist |
| Cole | Dev + UI | Prior RayLib experience | Implementer |
| Hamza | Dev + QA | Strongest at finding cross-module issues | Monitor Evaluator |

**Accountability:** RACI matrix — each WBS package has one R/A owner; Integration had three Consulted (cross-module risk)

**Agreements evolved through use:**
